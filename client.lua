          ...
          if IsPedInAnyVehicle(ped) == false then
            ...
            if pedType ~= 28 and IsPedAPlayer(ped) == false then
              ...
              if distance <= 4 and ped  ~= GetPlayerPed(-1) and ped ~= oldped then
                Draw3DText(pos.x, pos.y, pos.z + 1 , 'Presiona [~g~H~w~] para ofertar.') --// comente al inicio esta linea si no quiere mostrar texto
                  ...
                  if has then
                    ...
                    if random == 3 or random == 7 or random == 11 or random == 5 then
                      ...
                      exports.pNotify:SendNotification({
                        text = "La persona rechazó su oferta.",
                        type = "error",
...
while true do
  ...
  if selling then
    ...
    if distance > 6 then
      exports.pNotify:SetQueueMax("left", 1)
      exports.pNotify:SendNotification({
        text = "Venta cancelada: estás lejos ahora.",
        type = "error",
        timeout = math.random(100, 3500),
        layout = "centerLeft",
        queue = "left"
  ...
  function Draw3DText(x, y, z, text)
    ...
    DrawRect(0.0, 0.0+0.013, 0.04+ factor, 0.04, 0, 0, 0, 68)
